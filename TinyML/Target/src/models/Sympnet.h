...
int32_t PolynomialDerivation(const int32_t* coefficients, uint8_t numberOfCoefficients, int32_t m);
int32_t SymplecticTimeScale(int32_t h, int32_t dH);
void SympnetStateUpdate(phaseState_t *state, int32_t scale, const int32_t *weights);
