...
PINN_WEIGHT_FOLDER = os.path.join("PINN", "Weights", "pinn_int32_weights")
...
# MAIN CONVERSION
# =========================
def ConvertPINNParamsToQ16(params_path, output_folder):
...
def main():
    ConvertPINNParamsToQ16(PARAMS_PATH, PINN_WEIGHT_FOLDER)
