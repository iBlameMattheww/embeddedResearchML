...
PARAMS_PATH = os.path.join(PARAMS_PATH, 'vanillanet_paramsV1.json')
...
params = {
    "fc1": {
        "weight": vanillanet.fc1.weight.detach().cpu().numpy().tolist(),
        "bias": vanillanet.fc1.bias.detach().cpu().numpy().tolist(),
    },
    "fc2": {
        "weight": vanillanet.fc2.weight.detach().cpu().numpy().tolist(),
        "bias": vanillanet.fc2.bias.detach().cpu().numpy().tolist(),
    },
}
